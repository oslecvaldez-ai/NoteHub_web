...
export function registerExportIpc(): void {
	ipcMain.handle('export:toTXT', async (_event, title: string, content: string) => {
	...
	ipcMain.handle('export:toMD', async (_event, title: string, content: string) => {
	...
	ipcMain.handle('export:toHTML', async (_event, title: string, content: string) => {
	...
	ipcMain.handle('export:toPDF', async (_event, title: string, content: string) => {
	...
	ipcMain.handle('export:toNoteHub', async (_event, note: Record<string, unknown>) => {
		const title = typeof note.title === 'string' ? note.title : 'Nota'
		const defaultPath = getSaveFileName(title, 'notehub')
		const { canceled, filePath } = await dialog.showSaveDialog({
