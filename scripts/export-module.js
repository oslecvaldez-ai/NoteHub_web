...
// Agregamos scripts y archivos de salida previos a la lista de ignorados
...
// Asignar un nombre descriptivo si se exporta la raíz
let cleanName = targetPath.replace(/[\\/]/g, "_").replace(/^_+|_+$/g, "");
if (targetPath === "." || cleanName === "") {
  cleanName = "PROYECTO_COMPLETO";
}
...
console.log(
  "\x1b[36m%s\x1b[0m",
  `Empaquetando archivos de '${targetPath === "." ? "todo el proyecto" : targetPath}' en ${outputFile}...`,
);
